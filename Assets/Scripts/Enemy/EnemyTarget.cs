...
namespace WarIO.Enemy
{
    public class EnemyTarget
    {
        ...
        public void FindClosest()
        {
            ...
            var count = FindAllTargets(LayerUtils.PickUpLayer | LayerUtils.EnemyMask);
            ...
            if (_player != null && DistanceFromAgentTo(_agentTransform.gameObject) < minDistance) Closest = _player.gameObject;
        }
